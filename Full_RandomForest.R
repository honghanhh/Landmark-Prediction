...
setwd("C:/Users/Admin/Documents/Intern/Extract feature/Internship/TrainingData")
...
d_rf <- randomForest(rf.form, trainData, ntree=200, importance = T)
...
data = testData[1707:1832,c("X","Y","isLandmark","predicted_response")]
data = testData[1579:1706,c("X","Y","isLandmark","predicted_response")]
data = testData[1453:1578,c("X","Y","isLandmark","predicted_response")]
confusionMatrix(data=factor(data$predicted_response), reference=factor(data$isLandmark),positive='1')
